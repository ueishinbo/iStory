...
import cn.edu.xjtlu.istory.Object.CRUD;
import cn.edu.xjtlu.istory.Object.Section;
import cn.edu.xjtlu.istory.Object.SharedPre;
    ...
    public static class PersonalFragment extends Fragment {
        ...
        public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            ...
            collectionBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(view.getContext(),MyCollectionsActivity.class);
                    startActivity(intent);
                }
            });
            creationBtn = view.findViewById(R.id.creationBtn);
            creationBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(view.getContext(),MyCreationsActivity.class);
                    startActivity(intent);
                }
            });
            return view;
